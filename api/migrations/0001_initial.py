# Generated by Django 4.2.2 on 2024-04-26 12:38
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('device_test', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.device_results')),
                ('submitted', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.submitted_results')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
